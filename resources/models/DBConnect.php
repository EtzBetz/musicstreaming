...
class DBConnect {
    ...
    private function __construct() {
        $this->connection = new PDO('mysql:host=127.0.0.1;dbname=gw2raider', 'root', 'root', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8')); // TODO: Put connect data in config.php
