        ...
        <div class="card">
            <form action="{$configArr.urls.add_artist}&{$configArr.urls.do}create" onsubmit="return validateForm()" method="post" class="content--set-column">
                ...
                <div class="card__column content--set-column">
                    <input class="card__input" placeholder="{$configArr.strings.artisttitle}" type="text" alt="{$configArr.strings.artisttitle}" pattern="[A-z0-9À-ž\s]{ldelim}3,64{rdelim}" id="title" name="title" required>
